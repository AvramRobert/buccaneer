...
final class Cmd0(syntax0: Tree[Denot]) extends CmdBld[Nothing] {
  ...
  class Cmd1[A](types1: TypedC[A], syntax1: Tree[Denot]) extends CmdBld[A] {
    ...
    class Cmd2[B](types2: TypedC[B], syntax2: Tree[Denot]) extends CmdBld[B] {
      ...
      class Cmd3[C](types3: TypedC[C], syntax3: Tree[Denot]) extends CmdBld[C] {
        ...
        class Cmd4[D](types4: TypedC[D], syntax4: Tree[Denot]) extends CmdBld[D] {
          ...
          class Cmd5[E](types5: TypedC[E], syntax5: Tree[Denot]) extends CmdBld[E] {
            ...
            class Cmd6[F](types6: TypedC[F], syntax6: Tree[Denot]) extends CmdBld[F] {
              ...
              class Cmd7[G](types7: TypedC[G], syntax7: Tree[Denot]) extends CmdBld[G] {
                ...
                class Cmd8[H](types8: TypedC[H], syntax8: Tree[Denot]) extends CmdBld[H] {
                  ...
                  class Cmd9[I](types9: TypedC[I], syntax9: Tree[Denot]) extends CmdBld[I] {
                    ...
                    class Cmd10[J](types10: TypedC[J], syntax10: Tree[Denot]) extends CmdBld[J] {
